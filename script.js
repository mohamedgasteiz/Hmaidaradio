...
const radioStations = {
  "Algeria": [
    ...
    {
      name: "Radio Culture",
      url: "https://webradio.tda.dz/Culture_64K.mp3",
    ...
    {
      name: "Radio Bahdja",
      url: "https://webradio.tda.dz/Bahdja_64K.mp3",
      description: "Local Algiers Radio"
    },
    {
      name: "Chaine 2",
      url: "https://webradio.tda.dz/Chaine2_64K.mp3",
      description: "Amazigh Radio"
    },
    {
      name: "Chaine 3",
      url: "https://webradio.tda.dz/Chaine3_64K.mp3",
      description: "French Service"
    },
    {
      name: "Radio Soummam",
      url: "https://webradio.tda.dz/Soummam_64K.mp3",
      description: "Regional Radio"
    },
    {
      name: "Radio Sahara",
      url: "https://webradio.tda.dz/Sahara_64K.mp3",
      description: "Southern Algeria Radio"
    }
  ],
  "Australia": [
    {
  ...
  "Bahrain": [
    {
      name: "Bahrain FM",
      url: "https://5c7b683162943.streamlock.net/live/ngrp:bahrainfm_all/playlist.m3u8",
      description: "National Radio"
    },
    {
      name: "Radio Bahrain English",
      url: "https://5c7b683162943.streamlock.net/live/ngrp:radio96_all/playlist.m3u8",
  ...
  "Egypt": [
    ...
    },
    {
      ...
      description: "Arabic Contemporary"
    }
  ],
  "Iraq": [
    {
      name: "Radio Sawa Iraq",
      url: "https://mbn-channel-01.akacast.akamaistream.net/7/29/233450/v1/ibb.akacast.akamaistream.net/mbn_channel_01",
      description: "News & Music"
    },
    {
      name: "Radio Al Mirbad",
      url: "https://server.mirbad.org:8443/live",
      description: "Local News & Culture"
    }
  ],
  "Jordan": [
    {
      name: "Radio Jordan",
      url: "http://stream.joinvisions.net:1935/jorlive/radio_jordan/playlist.m3u8",
      description: "National Radio"
    },
    {
      name: "Amman FM",
      url: "http://stream.joinvisions.net:1935/jorlive/amman_fm/playlist.m3u8",
  ...
  "Kuwait": [
    {
      name: "Kuwait FM",
      url: "https://hiplayer.hibridcdn.net/t/kwmedia-kwtv1.m3u8",
      description: "National Radio"
    },
    {
      name: "Marina FM",
      url: "https://marina.mc/radio/8000/radio.mp3",
  ...
  "Lebanon": [
    {
      name: "Radio Lebanon",
      url: "http://audiostreaming.itworkscdn.com:9054/",
      description: "National Radio"
    },
    {
      name: "Mix FM Lebanon",
      url: "https://rs.hadara.ps:9556/stream",
      description: "Contemporary Hits"
    }
  ],
  "Netherlands": [
  ...
  "Oman": [
    {
      name: "Oman Radio General",
      url: "https://radio.omantel.om/GeneralService",
      description: "National Radio"
    },
    {
      name: "Oman Radio Youth",
      url: "https://radio.omantel.om/Youth",
  ...
  "Qatar": [
    {
      name: "QBS Radio",
      url: "https://qatarradio.qa/radio/channel1",
      description: "National Radio"
    },
    {
      name: "Oryx FM",
      url: "https://qatarradio.qa/radio/oryxfm",
      description: "English Service"
    }
  ],
  "Saudi Arabia": [
  ...
  "Syria": [
    {
      name: "Sham FM",
      url: "http://radio.shamfm.fm:8000/stream",
      description: "Contemporary Arabic"
    },
    {
      name: "Ninar FM",
      url: "http://ninarfm.grtvstream.com:8896/stream",
      description: "Syrian Pop"
    }
  ],
  "United Arab Emirates": [
    {
      name: "Dubai FM",
      url: "https://dmifm.ae/dubaifm",
      description: "Arabic Contemporary"
    },
    {
      name: "Virgin Radio Dubai",
      url: "https://stream.virginradiodubai.com/virgin-radio",
      description: "English Pop Music"
    }
  ],
  "United Kingdom": [
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function displayStations(country) {
    ...
    // Automatically play the first station when stations are displayed
    if (country === "Algeria" && currentStationIndex === -1) {
      playStation(country, 0);
    }
  }

  function playStation(country, index, isAutoRetry = false) {
    if (index >= 0 && index < radioStations[country].length) {
      ...
      if (playPromise !== undefined) {
        playPromise.catch(error => {
          ...
          trackTitle.textContent = languages[currentLang].unableToPlay;
          
          // If playback fails, try the next station
          if (index < radioStations[country].length - 1) {
            console.log("Trying next station...");
            playStation(country, index + 1, true);
          } else if (index === radioStations[country].length - 1 && !isAutoRetry) {
            // If we're at the last station, start from the beginning
            console.log("Trying first station...");
            playStation(country, 0, true);
          }
        });
      }
  ...
  audioPlayer.addEventListener('error', (e) => {
    ...
    // Try the next station on error
    const country = countrySelect.value;
    if (currentStationIndex < radioStations[country].length - 1) {
      playStation(country, currentStationIndex + 1, true);
    } else {
      // If we're at the last station, start from the beginning
      playStation(country, 0, true);
    }
  ...
  function updateLanguage(lang) {
    ...
    document.getElementById('country-select').querySelector('option:first-child').textContent = languages[lang].selectCountry;
    document.getElementById('language-select').querySelector('option[value="en"]').textContent = languages[lang].english;
    document.getElementById('language-select').querySelector('option[value="es"]').textContent = languages[lang].spanish;
    document.getElementById('language-select').querySelector('option[value="nl"]').textContent = languages[lang].dutch;
    document.getElementById('language-select').querySelector('option[value="ar"]').textContent = languages[lang].arabic;
    document.getElementById('language-select').querySelector('option[value="fr"]').textContent = languages[lang].french;
    ...
    // Also update any error messages if they're currently displayed
    const currentTrackTitle = document.getElementById('track-title').textContent;
    if (currentTrackTitle.includes('Unable to play') || currentTrackTitle.includes('Error playing')) {
      document.getElementById('track-title').textContent = languages[lang].unableToPlay;
    }

    // Update country names based on selected language if needed
    const countrySelect = document.getElementById('country-select');
    const selectedCountry = countrySelect.value;
  
    // Clear and repopulate country select
    countrySelect.innerHTML = `<option value="">${languages[lang].selectCountry}</option>`;
    ...
    countrySelect.value = selectedCountry || "Algeria";
  }
